...
<div style="margin-bottom:5px;"></div>
	  ...
	  <div class="quick_info">
						...
						<div class="quick_info_content">
							<dl>
								...
								$remaining_sms_credit=admin_credit_info($con,$login_user_name);
						...
						?></dt>
							...
							<dd>Valid Upto: </dd>
								<dt><?php     
									$remaining_date_info=admin_date_info($con,$login_user_name);
									echo $validdate=$remaining_date_info['user_valid_date'];
						...
						?></dt>
							...
							<h2 style="color:red;">Validation Date Expired.</h2>	
							</dl>
							<?php
							}
							?>
	...
	<div id="footer">
		...
		<dl class="copy">
			<dt><strong>Free SMS</strong> <em>2024</em></dt>
			<dd>&copy; Playon24.  All rights reserved.</dd>
		</dl>
