    											...
    											<div class="row">
															...
															<div class="inputs">
																...
																<span class="input_wrapper textarea_wrapper">
																	<textarea rows="" name="text" cols="" class="text" onKeyPress="return taLimit2(this)" onKeyUp="return taCount2(this,'myCounter2')"></textarea>
																</span>
															</div>
														</div>
                    									...
                    									<p style="margin-left:450px;">You have <B><SPAN id="myCounter2" style="color:#06F;">67</SPAN></B> characters remaining...</p>
	...
	if(isset($_REQUEST['send_sms_submit'])){
		...
		$num_of_sending_sms=$n;
			...
			if(chk_sms_credit($num_of_sending_sms,$_SESSION['_u_li_'])==1){	
					if(chk_valid_date($_SESSION['_u_li_'])==1){
